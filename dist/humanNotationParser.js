...
exports.humanToLisp = humanToLisp;
exports.parseEquation = parseEquation;
var HumanTokenType;
(function (HumanTokenType) {
    HumanTokenType[HumanTokenType["Number"] = 0] = "Number";
    HumanTokenType[HumanTokenType["Variable"] = 1] = "Variable";
    HumanTokenType[HumanTokenType["Plus"] = 2] = "Plus";
...
function tokenizeHumanNotation(input) {
    const tokens = [];
    let i = 0;
